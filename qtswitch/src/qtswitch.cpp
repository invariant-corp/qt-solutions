...
QtSwitch::QtSwitch( QWidget* parent )
: QWidget( parent ),
  m_value( false ),
  m_type( Vertical )
{
...
void QtSwitch::paintEvent( QPaintEvent* )
{
...
void QtSwitch::setValue( bool value )
{
   m_value = value;
   this->update();
...
void QtSwitch::setType( SwitchType type )
{
   m_type=type;
   this->update();
...
void QtSwitch::mouseReleaseEvent( QMouseEvent* )
{
   this->toggleValue();  
...
void QtSwitch::keyReleaseEvent( QKeyEvent* e )
{
